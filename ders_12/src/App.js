...
import LoginProvider from "./context/LoginProvider";
  ...
  //CONTEXT API : GLOBAL STATE PAYLASIMI SAGLAYAN BIR API YANI INTERFACE(MANAGEMENT). PROP DRILLING'IN ZOR OLDUGU YERLERDE KULLANILIR. USE.STATE'LER ILE BIRLIKTE FALAN KULLANILABILIR. 
  //BIR STATE, BAGLI OLMAYAN IKI SAYFA ICERISINDE KULLANILACAKSA BU STATE'I LIFTING-UP ILE IKI SAYFANIN ORTAK PARENT'INA VERIRIZ. PROP YONTEMIYLE CHILD ELEMENTE GONDERIRIZ(PROP DRILLING(kaymak)).
  ...
  //2) SARMALANMASI: 
                  ...
                  // <APP/> (tum childler bunlara erısebılır.)
