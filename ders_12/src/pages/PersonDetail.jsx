...
const PersonDetail = () => {
    ...
    const getPerson = () => {
      ...
      // FONKSIYONU TANIMLA, FETCH ILE VERIYI AL, JSON FORMATINA CEVIR, STATE DEGERINE AKTAR, USE.EFFECT ILE FONKSIYONUNU BASLANGICTA CALISTIR, GUNCELLEME ICIN DEPENDENCY VARIABLE EKLEYEBILIRSIN.
